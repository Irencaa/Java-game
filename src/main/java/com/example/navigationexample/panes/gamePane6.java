...
import com.example.navigationexample.IntroScene.gameScene7;
...
public class gamePane6 extends BorderPane {
    ...
    public gamePane6() {
        ...
        hiddenWord = "adidas"; // Fixed word "google" for demonstration
        guessedLetters = "";
        ...
        ImageView imageView = new ImageView(new Image("./images/adidas.png"));
        ...
        if (incorrectGuessCount >= maxIncorrectGuesses) {
            ...
            nextLevelButton.setOnAction(new EventHandler<ActionEvent>() {
                ...
                public void handle(ActionEvent actionEvent) {
                    HelloApplication.mainStage.setScene(new gameScene7());
                }
            });
