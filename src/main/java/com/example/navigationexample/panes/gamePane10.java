...
public class gamePane10 extends BorderPane {
    ...
    public gamePane10() {
        ...
        hiddenWord = "norway"; // Fixed word "google" for demonstration
        guessedLetters = "";
        ...
        ImageView imageView = new ImageView(new Image("./images/Norway.webp"));
