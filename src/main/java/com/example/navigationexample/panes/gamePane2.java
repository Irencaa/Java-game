...
public class gamePane2 extends BorderPane {
    String hiddenWord;
    ...
    public gamePane2() {
        ...
        hiddenWord = "switzerland"; // Fixed word "google" for demonstration
        guessedLetters = "";
        ...
        ImageView imageView = new ImageView(new Image("./images/switzerland.png"));
        ...
        if (incorrectGuessCount >= maxIncorrectGuesses) {
            ...
            nextLevelButton.setOnAction(new EventHandler<ActionEvent>() {
                ...
                public void handle(ActionEvent actionEvent) {
                    HelloApplication.mainStage.setScene(new gameScene3());
                }
            });
