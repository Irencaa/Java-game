...
import com.example.navigationexample.IntroScene.gameScene2;
import com.example.navigationexample.IntroScene.gameScene9;
...
public class gamePane8 extends BorderPane {
    ...
    public gamePane8() {
        ...
        hiddenWord = "lincoln"; // Fixed word "google" for demonstration
        guessedLetters = "";
        ...
        ImageView imageView = new ImageView(new Image("./images/lincoln.png"));
    ...
    // Method to create buttons for alphabet
    ...
    // Method to handle guessing a letter
        ...
        if (incorrectGuessCount >= maxIncorrectGuesses) {
            ...
            nextLevelButton.setOnAction(new EventHandler<ActionEvent>() {
                ...
                public void handle(ActionEvent actionEvent) {
                    HelloApplication.mainStage.setScene(new gameScene9());
                }
            });
    ...
    // Method to get the hidden word with guessed letters
