...
import com.example.navigationexample.IntroScene.gameScene4;
...
public class gamePane3 extends BorderPane {
    String hiddenWord;
    ...
    public gamePane3() {
        ...
        hiddenWord = "mexico"; // Fixed word "google" for demonstration
        guessedLetters = "";
        ...
        ImageView imageView = new ImageView(new Image("./images/mexico.jpeg"));
        ...
        if (incorrectGuessCount >= maxIncorrectGuesses) {
            ...
            nextLevelButton.setOnAction(new EventHandler<ActionEvent>() {
                ...
                public void handle(ActionEvent actionEvent) {
                    HelloApplication.mainStage.setScene(new gameScene4());
                }
            });
