...
import com.example.navigationexample.IntroScene.gameScene10;
...
public class gamePane9 extends BorderPane {
    ...
    public gamePane9() {
        ...
        hiddenWord = "panama"; // Fixed word "google" for demonstration
        guessedLetters = "";
        ...
        ImageView imageView = new ImageView(new Image("./images/panama.png"));
        ...
        if (incorrectGuessCount >= maxIncorrectGuesses) {
            ...
            nextLevelButton.setOnAction(new EventHandler<ActionEvent>() {
                ...
                public void handle(ActionEvent actionEvent) {
                    HelloApplication.mainStage.setScene(new gameScene10());
                }
            });
