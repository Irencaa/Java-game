...
public class gamePane4 extends BorderPane {
    String hiddenWord;
    ...
    public gamePane4() {
        ...
        hiddenWord = "mazda"; // Fixed word "google" for demonstration
        guessedLetters = "";
        ...
        ImageView imageView = new ImageView(new Image("./images/mazda.jpeg"));
        ...
        if (incorrectGuessCount >= maxIncorrectGuesses) {
            ...
            nextLevelButton.setOnAction(new EventHandler<ActionEvent>() {
                ...
                public void handle(ActionEvent actionEvent) {
                    HelloApplication.mainStage.setScene(new gameScene5());
                }
            });
