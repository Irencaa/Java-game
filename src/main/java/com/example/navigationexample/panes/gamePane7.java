...
import com.example.navigationexample.IntroScene.gameScene8;
...
public class gamePane7 extends BorderPane {
    ...
    public gamePane7() {
        ...
        hiddenWord = "albania"; // Fixed word "google" for demonstration
        guessedLetters = "";
        ...
        ImageView imageView = new ImageView(new Image("./images/albania.jpg"));
        ...
        if (incorrectGuessCount >= maxIncorrectGuesses) {
            ...
            nextLevelButton.setOnAction(new EventHandler<ActionEvent>() {
                ...
                public void handle(ActionEvent actionEvent) {
                    HelloApplication.mainStage.setScene(new gameScene8());
                }
            });
